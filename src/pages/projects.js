...
import FSmind from '../assets/full-mindtime.gif'
import FSroom from '../assets/full-roominate.gif'
import FSlol from '../assets/full-lol.gif'
import FSwear from '../assets/full-weredar-it.gif'
      ...
      <div className="Projects section flex-container">
        ...
        <div className="item">
          ...
          <Modal open={modal2} onClose={this.onCloseModal2} little>
            <div className="text">
              <h1>ROOMIATE</h1>
              <strong>Question game for frineds!</strong>
              <p>
        ...
        <div className="item">
          ...
          <Modal open={modal3} onClose={this.onCloseModal3} little>
            <div className="text">
              <h1>Leauge of legends planner</h1>
              <strong>
                Used to help friends orgonize times to play together
              </strong>
              <p>
